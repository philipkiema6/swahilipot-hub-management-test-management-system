    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='fmreport/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='fmreport.fmstatusreport')),
            ],
        ),
        migrations.AddIndex(model_name='fmstatusreport', index=models.Index(fields=['status', 'created_at'], name='fmreport_status__idx')),
    ]
