    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='equipment/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='equipment.equipment')),
            ],
        ),
        migrations.AddIndex(model_name='equipment', index=models.Index(fields=['status', 'created_at'], name='equipment_status__idx')),
    ]
