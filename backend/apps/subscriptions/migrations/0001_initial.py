    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='subscriptions/%Y/%m/')),
        ...
        migrations.CreateModel(
            name='SoftwareSubscriptionAuditLog',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='subscriptions.softwaresubscription')),
            ],
        ),
        migrations.AddIndex(model_name='softwaresubscription', index=models.Index(fields=['status', 'created_at'], name='subscriptions_status__idx')),
    ]
