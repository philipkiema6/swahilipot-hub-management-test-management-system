    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='filetransfer/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='filetransfer.filetransfer')),
            ],
        ),
        migrations.AddIndex(model_name='filetransfer', index=models.Index(fields=['status', 'created_at'], name='filetransfer_status__idx')),
    ]
