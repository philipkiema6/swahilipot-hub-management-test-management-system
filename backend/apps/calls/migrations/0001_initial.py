    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='calls/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='calls.callrecording')),
            ],
        ),
        migrations.AddIndex(model_name='callrecording', index=models.Index(fields=['status', 'created_at'], name='calls_status__idx')),
    ]
