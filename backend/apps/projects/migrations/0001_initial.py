...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ProjectSubmissionAuditLog',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='projects.projectsubmission')),
            ],
        ),
        migrations.AddIndex(model_name='projectsubmission', index=models.Index(fields=['status', 'created_at'], name='projects_status__idx')),
    ]
