    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='videography/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='videography.shootrequest')),
            ],
        ),
        migrations.AddIndex(model_name='shootrequest', index=models.Index(fields=['status', 'created_at'], name='videography_status__idx')),
    ]
