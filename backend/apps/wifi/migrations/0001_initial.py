    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='wifi/%Y/%m/')),
        ...
        migrations.CreateModel(
            name='WifiAccessRequestAuditLog',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='wifi.wifiaccessrequest')),
            ],
        ),
        migrations.AddIndex(model_name='wifiaccessrequest', index=models.Index(fields=['status', 'created_at'], name='wifi_status__idx')),
    ]
